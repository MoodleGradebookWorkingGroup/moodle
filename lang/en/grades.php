...
$string['forcesumofgrades'] = 'Sum of grades forced, special processing will take place';
...
$string['nosumofgrades'] = 'No special processing of Sum of grades only gradebooks';
...
$string['optionalsumofgrades'] = 'Special processing for Sum of grades categories if all gradebook categories are set to Sum of grades';
