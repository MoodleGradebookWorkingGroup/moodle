...
class grade_edit_tree_local_column_range extends grade_edit_tree_column {
...
//        		$itemcell->text = '<label class="accesshide" for="weight'.$params['gtree']->grades[$item->id]->id.'">'.get_string('editweight', 'grades').'</label>
